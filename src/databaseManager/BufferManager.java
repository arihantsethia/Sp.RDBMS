...
public class BufferManager {
	...
	if (lookUpMap.containsKey(physicalAddress)) {
	    ...
	    pagePool[lookUpMap.get(physicalAddress).intValue()].put(pageMod / Byte.SIZE, bitSet.toByteArray()[0]);
	    return true;
	}
	return false;
    }
	...
	if (lookUpMap.containsKey(physicalAddress)) {
	    ...
	    pagePool[lookUpMap.get(physicalAddress).intValue()].put(recordNumber / Byte.SIZE, bitSet.toByteArray()[0]);
